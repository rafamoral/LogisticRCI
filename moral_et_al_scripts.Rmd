---
title: "Logistic versus linear regression-based Reliable Change Index: Implications for clinical studies with diverse sample sizes"
author:
  - Rafael A. Moral
  - Unai Diaz-Orueta
...
adni <- adni %>%
  dplyr::select(AGE, PTEDUCAT, PTGENDER, AVLT_DEL_6M, AVLT_DEL_BL)

adni <- adni %>%
  filter(AVLT_DEL_6M > 0 & AVLT_DEL_BL > 0)

names(adni) <- c("age","education","gender","score","baseline")
